  ...
  return (
    ...
    <div className="flex-wrap items-center py-10 justify-between space-y-14 sm:flex sm:space-y-0"
        ...
        <button 
          ...
          className="flex items-center ga-1 cursor-pointer hover-animation">
            Read More
            <img src="assets/arrow-right.svg" className="w-5"/>
        </button>
      
       </div>
      <div className='bg-gradient-to-r from-transport via-neutral-700 to-transparent h-[1px] w-full' />
